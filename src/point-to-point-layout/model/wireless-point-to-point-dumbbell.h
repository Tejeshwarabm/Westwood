...
#ifndef WIRELESS_POINT_TO_POINT_DUMBBELL_HELPER_H
#define WIRELESS_POINT_TO_POINT_DUMBBELL_HELPER_H
...
/**
 * \ingroup wireless-point-to-point-layout
 *
 * \brief A helper to make it easier to create a dumbbell topology
 * with p2p links
 */
class WirelessPointToPointDumbbellHelper
{
public:
  /**
   ...
   *                         the bottleneck link
   */
  WirelessPointToPointDumbbellHelper (uint32_t nLeftLeaf,
                              uint32_t nRightLeaf,
                              PointToPointHelper rightHelper,
                              PointToPointHelper centrallinkHelper,
                              std::string mobilityModel);

  ~WirelessPointToPointDumbbellHelper ();
...
#endif /* WIRELESS_POINT_TO_POINT_DUMBBELL_HELPER_H */
